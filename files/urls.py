...
urlpatterns = [
    ...
    path("folders/", cache_page(60)(views.FoldersListView.as_view()), name="folders_list"),
    ...
    path(
        "folders/<int:pk>/", cache_page(60)(views.FilesByFoldersView.as_view()), name="files_by_folders"
    ),
    path("folders/create/", views.FoldersCreateView.as_view(), name="folders_create"),
    path("files/", cache_page(60)(views.FavouritesFilesView.as_view()), name="files_by_favourites"),
    path(
        "files/recent", cache_page(60)(views.RecentListView.as_view()), name="recent_files_and_folders"
    ),
]